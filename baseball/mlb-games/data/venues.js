...
var mlbVenues = {
  ...
  "loanDepot Park": { lat: 25.7781, lng: -80.2197, slug: "marlins" },
  ...
  "American Family Field": { lat: 43.0283, lng: -87.9712, slug: "brewers" },
  "PNC Park": { lat: 40.4469, lng: -80.0057, slug: "pirates" },
  "Busch Stadium": { lat: 38.6226, lng: -90.1928, slug: "cardinals" },
  "Chase Field": { lat: 33.4453, lng: -112.0669, slug: "diamondbacks" },
  ...
  "Rogers Centre": { lat: 43.6414, lng: -79.3894, slug: "bluejays" },
  ...
  "Daikin Park": { lat: 29.7572, lng: -95.3556, slug: "astros" },
  "Angel Stadium": { lat: 33.8003, lng: -117.8827, slug: "angels" },
  "Sutter Health Park": { lat: 38.5802, lng: -121.5010, slug: "athletics" },
  "T-Mobile Park": { lat: 47.5914, lng: -122.3324, slug: "mariners" },
  "Globe Life Field": { lat: 32.7473, lng: -97.0820, slug: "rangers" },
  ...
  "Minute Maid Park": { lat: 29.7572, lng: -95.3556, slug: "astros" },
  ...
  "Miller Park": { lat: 43.0283, lng: -87.9712, slug: "brewers" },
  "Safeco Field": { lat: 47.5914, lng: -122.3324, slug: "mariners" },
